...
import Bg from "../../../images/Frame 1000002379.png";
    ...
    <div className="w-11/12 mx-auto px-4 md:px-0 lg:pl-16 flex flex-col md:flex-row items-center justify-center mt-16 lg:mt-0 h-screen 2xl:h-full gap-12">
      ...
      <div className="w-full md:w-2/3 lg:w-1/2 mx-auto">
        <div className="text-[#181A20D1] space-y-2">
          ...
          <p className="text-[#181A20D1] text-xs">Let's get started by filling out the information below</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
          <div className="text-[#181A20D1] text-xs flex flex-col gap-2">
            ...
            <div className="flex gap-6">
              <div className="w-[46%] md:w-1/2 flex flex-col gap-2">
          ...
          <div className="flex gap-2 pt-2 pb-4">
            ...
            />
            <span className="text-[#716F6F] text-xs">
      ...
      {/* Image Section */}
      <div className="relative hidden lg:block w-full md:w-1/2 mx-auto">
        <Image
          width={779}
          height={1028}
          src={Bg}
